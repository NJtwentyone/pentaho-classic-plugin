  ...
  const clonedStartAdornment = React.useMemo(
    () => applyClassNameAndStateToElement(
      ...
      cx(
        ...
        React__default.default.isValidElement(startAdornment) ? startAdornment.props.className : void 0
      )
    ),
    [
      cx,
  ...
  const clonedEndAdornment = React.useMemo(
    () => applyClassNameToElement(
      ...
      cx(
        ...
        { [classes.disabled]: disabled },
        React__default.default.isValidElement(endAdornment) ? endAdornment.props.className : void 0
      )
    ),
