...
const { staticClasses, useClasses } = createClasses("HvTagsInput", {
  input: {
    width: "100%",
  ...
  tagInputRoot: {
    ...
    [`& .${staticClasses$1.inputBorderContainer}`]: {
      border: "none",
      background: "none"
    },
    [`& .${staticClasses$1.inputRootFocused}`]: {
      outline: "none",
      boxShadow: "none"
    },
    [`& .${staticClasses$1.root} .${staticClasses$1.inputRootReadOnly}`]: {
