...
const HvAvatar = React.forwardRef((props, ref) => {
  ...
  if (!hasImgNotFailing) {
    inlineStyle.backgroundColor = uikitStyles.getColor(
      backgroundColor,
      uikitStyles.theme.colors.secondary
    );
  ...
  return /* @__PURE__ */ jsxRuntime.jsx("div", { ref, className: classes.container, ...others, children: /* @__PURE__ */ jsxRuntime.jsxs(
    "div",
    {
