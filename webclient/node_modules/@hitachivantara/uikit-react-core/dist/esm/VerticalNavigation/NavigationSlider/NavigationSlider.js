...
const HvVerticalNavigationSlider = (props) => {
  ...
  return /* @__PURE__ */ jsx(HvListContainer, { interactive: true, id, children: data && data.map((item) => /* @__PURE__ */ jsx(
    HvListItem,
    {
      classes: {
        root: classes.root,
