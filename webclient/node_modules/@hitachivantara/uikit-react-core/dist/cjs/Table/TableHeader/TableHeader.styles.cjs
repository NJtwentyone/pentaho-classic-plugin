...
const { staticClasses, useClasses } = classes.createClasses("HvTableHeader", {
  root: {
  ...
  resizable: { borderRight: `solid 1px ${uikitStyles.theme.colors.atmo4}` },
  resizing: { borderRight: `solid 2px ${uikitStyles.theme.colors.secondary}` },
  resizer: {
