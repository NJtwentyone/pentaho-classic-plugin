...
const HvRightControl = ({
  ...
  const { classes, cx } = RightControl_styles.useClasses(classesProp);
  const [dropDownValues, setDropdownValues] = React.useState(values);
  const { onSort: onSortHandler } = React.useContext(ControlsContext.HvControlsContext);
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { id, className: cx(classes.root, className), ...others, children: [
    !hideSortBy && /* @__PURE__ */ jsxRuntime.jsx(
      Dropdown.HvDropdown,
      {
        id: setId.setId(id, "sort-by-dropdown"),
