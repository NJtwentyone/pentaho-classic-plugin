...
const SavedColors = (props) => {
  ...
  const { classes } = SavedColors_styles.useClasses(classesProp);
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: classes.root, children: [
    /* @__PURE__ */ jsxRuntime.jsx(
      Button.HvButton,
      {
        ...
        children: /* @__PURE__ */ jsxRuntime.jsx(uikitReactIcons.Add, { "aria-hidden": true })
      }
    ),
    colors.map((color, index) => /* @__PURE__ */ jsxRuntime.jsxs(
      "div",
      {
        className: classes.swatchRoot,
        children: [
          /* @__PURE__ */ jsxRuntime.jsx("div", { className: classes.swatchWrap, children: /* @__PURE__ */ jsxRuntime.jsx(
            common.Swatch,
            {
              color,
              onClick: handleClick,
          ...
          /* @__PURE__ */ jsxRuntime.jsx("div", { className: classes.removeButtonRoot, children: /* @__PURE__ */ jsxRuntime.jsx(
            Button.HvButton,
            {
