...
const baseline = {
  ...
  ".uikit-root-element": {
    ...
    accentColor: theme.theme.colors.secondary,
    ...
    letterSpacing: theme.theme.typography.body.letterSpacing,
    fontFamily: theme.theme.fontFamily.body
  }
};
const CssScopedBaseline = {
  height: "100%",
  fontFamily: "inherit",
  lineHeight: "inherit",
...
exports.CssScopedBaseline = CssScopedBaseline;
