...
const ds3 = makeTheme.makeTheme((theme) => ({
  name: "ds3",
  colors: {
    modes: {
      dawn: {
        ...
        containerBackgroundHover: colors.colors.light.atmo3,
      ...
      wicked: {
        ...
        containerBackgroundHover: colors.colors.dark.atmo3,
        ...colors.colors.common,
        ...colors.colors.dark,
        positive: "#63A621",
        neutral: "#72CCCB",
