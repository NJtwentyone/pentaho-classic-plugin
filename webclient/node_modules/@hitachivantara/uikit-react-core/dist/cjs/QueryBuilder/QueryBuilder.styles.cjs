...
const { useClasses, staticClasses } = classes.createClasses("HvQueryBuilder", {
  ...
  topRemoveButtonDisabled: { backgroundColor: uikitStyles.theme.colors.atmo2 },
  ...
  topActionButtonContainer: {
    position: "absolute",
    bottom: `calc(-1 * ${uikitStyles.theme.space.md} * 0.5 - 3px)`,
    right: `calc(${uikitStyles.theme.space.sm} * 1.75 + 2px)`
  },
