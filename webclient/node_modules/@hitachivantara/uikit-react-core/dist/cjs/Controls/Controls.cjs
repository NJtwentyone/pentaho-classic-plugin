...
const HvControls = (props) => {
  ...
  const { classes, cx } = Controls_styles.useClasses(classesProp);
  const [currentView, setCurrentView] = useControlled.useControlled(
    selectedView,
    defaultView
  );
  ...
  return /* @__PURE__ */ jsxRuntime.jsx("div", { id, className: cx(classes.root, className), children: /* @__PURE__ */ jsxRuntime.jsxs(
    ControlsContext.HvControlsContextProvider,
    {
      value: {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: cx(classes.section, classes.rightSection), children: [
          rightChildren,
          views && !hideViewSwitcher && views?.length > 0 && /* @__PURE__ */ jsxRuntime.jsx(MultiButton.HvMultiButton, { id: setId.setId(id, "view-multi-button"), children: views.map(({ id: btnId, icon, ...others }) => /* @__PURE__ */ jsxRuntime.jsx(
            Button.HvButton,
            {
              id: btnId,
              icon: true,
