  ...
  const clonedStartAdornment = useMemo(
    () => applyClassNameAndStateToElement(
      ...
      cx(
        ...
        React__default.isValidElement(startAdornment) ? startAdornment.props.className : void 0
      )
    ),
    [
      cx,
  ...
  const clonedEndAdornment = useMemo(
    () => applyClassNameToElement(
      ...
      cx(
        ...
        { [classes.disabled]: disabled },
        React__default.isValidElement(endAdornment) ? endAdornment.props.className : void 0
      )
    ),
