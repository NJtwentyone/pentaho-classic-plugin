...
const NumericValue = ({
  ...
  const renderRangeInputs = (rangeValue) => /* @__PURE__ */ jsxs(
    "div",
    {
      className: cx(classes.rangeContainer, { [classes.isMdDown]: isMdDown }),
      children: [
        /* @__PURE__ */ jsx("div", { className: classes.inputContainer, children: /* @__PURE__ */ jsx(
          HvInput,
          {
  ...
  return /* @__PURE__ */ jsxs("div", { className: classes.root, children: [
    ...
    !isRange && /* @__PURE__ */ jsx("div", { className: classes.inputContainer, children: /* @__PURE__ */ jsx(
      HvInput,
      {
