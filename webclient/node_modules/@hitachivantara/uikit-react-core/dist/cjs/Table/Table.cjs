...
const HvTable = React.forwardRef((props, ref) => {
  const {
    ...
    variant = "default",
    ...others
  } = useDefaultProps.useDefaultProps("HvTable", props);
  const { classes, cx } = Table_styles.useClasses(classesProp);
  ...
  const Table = React.useMemo(() => components.Table, [components]);
  return /* @__PURE__ */ jsxRuntime.jsx(TableContext.default.Provider, { value: tableContext, children: /* @__PURE__ */ jsxRuntime.jsx(
    Table,
    {
      ref,
