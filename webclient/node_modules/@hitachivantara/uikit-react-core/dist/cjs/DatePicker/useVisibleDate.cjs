...
const visibleDateReducer = (state, action) => {
...
function stateFromRange(startDate, endDate) {
  const initialStartDate = utils.validateDate(startDate);
  const initialEndDate = endDate != null ? utils.validateDate(endDate) : initialStartDate;
...
exports.default = useVisibleDate;
