...
const pathWithSubMenu = (id, listRoute, maxVisible, onClick, dropDownMenuProps) => {
  ...
  listRoute.splice(
    ...
    /* @__PURE__ */ jsxRuntime.jsx(
      ...
      {
        id: setId.setId(id, "submenu"),
        icon: /* @__PURE__ */ jsxRuntime.jsx(uikitReactIcons.MoreOptionsHorizontal, { iconSize: "S", color: "secondary" }),
...
exports.pathWithSubMenu = pathWithSubMenu;
