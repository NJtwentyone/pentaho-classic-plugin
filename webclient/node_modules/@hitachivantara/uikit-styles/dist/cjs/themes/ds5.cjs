...
const ds5 = makeTheme.makeTheme((theme) => ({
  name: "ds5",
  colors: {
    modes: {
      dawn: {
        type: "light",
        backgroundColor: colors.colors.light.atmo2,
        containerBackgroundHover: colors.colors.light.primary_20,
        ...colors.colors.common,
        ...colors.colors.light
      },
      wicked: {
        type: "dark",
        backgroundColor: colors.colors.dark.atmo2,
        containerBackgroundHover: colors.colors.dark.primary_20,
        ...colors.colors.common,
        ...colors.colors.dark
      }
    }
