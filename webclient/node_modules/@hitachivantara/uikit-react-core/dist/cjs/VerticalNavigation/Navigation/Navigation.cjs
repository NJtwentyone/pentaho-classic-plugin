...
const createListHierarchy = (items, id, classes, mouseEnterHandler, disableTooltip = false) => items.map((item) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    TreeViewItem.HvVerticalNavigationTreeViewItem,
    {
...
const HvVerticalNavigationTree = ({
  ...
  const treeViewItemMouseEnterHandler = React.useCallback(
    (event, item) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    "nav",
    {
      ...
      ...others,
      children: slider ? /* @__PURE__ */ jsxRuntime.jsx(
        NavigationSlider.HvVerticalNavigationSlider,
        {
        ...
        TreeView.HvVerticalNavigationTreeView,
        {
          ...
          children: [
            useIcons && !isOpen && navigationPopup && /* @__PURE__ */ jsxRuntime.jsx(
              NavigationPopupContainer.NavigationPopupContainer,
              {
                ...
                children: /* @__PURE__ */ jsxRuntime.jsx(
                  HvVerticalNavigationTree,
                  {
                    ...
                    id: setId.setId(id, "navigation-popup-tree"),
                    collapsible: true,
