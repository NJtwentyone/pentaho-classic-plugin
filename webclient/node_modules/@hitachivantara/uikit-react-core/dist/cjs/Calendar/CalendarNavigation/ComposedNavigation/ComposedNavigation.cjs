...
const HvComposedNavigation = ({
  ...
  const { classes } = ComposedNavigation_styles.useClasses(classesProp);
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: classes.navigationContainer, ...others, children: [
    /* @__PURE__ */ jsxRuntime.jsx("div", { className: classes.navigationMonth, children: /* @__PURE__ */ jsxRuntime.jsx(
      Navigation.Navigation,
      {
        id: setId.setId(id, "navigation-month"),
    ...
    /* @__PURE__ */ jsxRuntime.jsx(
      Navigation.Navigation,
      {
        id: setId.setId(id, "navigation-year"),
