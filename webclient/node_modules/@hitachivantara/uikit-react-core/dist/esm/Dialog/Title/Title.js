...
const HvDialogTitle = (props) => {
  ...
  return /* @__PURE__ */ jsx(
    MuiDialogTitle,
    {
      ...
      ...others,
      children: /* @__PURE__ */ jsxs("div", { className: classes.messageContainer, children: [
        icon,
        /* @__PURE__ */ jsx("div", { className: cx({ [classes.textWithIcon]: !!icon }), children: !isString ? children : /* @__PURE__ */ jsx(HvTypography, { variant: "title4", className: classes.titleText, children }) })
      ] })
    }
  );
};
