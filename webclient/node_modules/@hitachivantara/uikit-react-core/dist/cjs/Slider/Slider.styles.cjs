...
const dragSquare = {
  ...
  borderTop: `12px solid ${uikitStyles.theme.colors.primary_20}`,
  borderBottom: `12px solid ${uikitStyles.theme.colors.primary_20}`,
  zIndex: "-2"
};
const ring = {
  width: "32px",
  height: "32px",
  borderRadius: "50%",
  border: `9px solid ${uikitStyles.theme.colors.primary_20}`,
  opacity: "100%",
  content: "''",
  position: "absolute",
  top: "-10px",
...
const sliderStyles = {
  ...
  rail: { backgroundColor: uikitStyles.theme.colors.atmo4, height: "1px", zIndex: "-3" }
};
const { staticClasses, useClasses } = classes.createClasses("HvSlider", {
  sliderBase: { ...base.default },
  rootDisabled: {
    cursor: "not-allowed",
    "&& .rc-slider-disabled": {
      background: "transparent"
