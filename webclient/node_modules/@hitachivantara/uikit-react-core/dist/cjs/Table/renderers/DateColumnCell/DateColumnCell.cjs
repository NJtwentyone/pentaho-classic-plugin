...
const HvDateColumnCell = ({
  ...
  const formattedDate = React.useMemo(() => {
    if (date)
      return dayjs__default.default(date).format(
        dateFormat !== "ISO8601" ? dateFormat : void 0
      );
    return "—";
  }, [date, dateFormat]);
  return /* @__PURE__ */ jsxRuntime.jsx(OverflowTooltip.HvOverflowTooltip, { data: formattedDate });
};
exports.HvDateColumnCell = HvDateColumnCell;
